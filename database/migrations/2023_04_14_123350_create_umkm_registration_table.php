...
return new class extends Migration
{
    ...
    {
        Schema::create('umkm_registration', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamp('regist_at')->nullable();
            $table->string('umkm_logo');
            $table->string('umkm_permission')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('umkm_registration');
    }
};
