...
<div class="container">
    <div class="row g-5 align-items-center">
        <form action="/umkm_registration" method="GET" class="col-auto ms-auto">
        ...
        <div class="col-md-15">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">UMKM Registration</h3>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <table class="table">
                            ...
                            @foreach($umkm_registration as $t)
                            <tbody>
                                <tr>
                                    <td>{{$t->umkm_name}}</td>
                                    <td>{{$t->umkm_owner}}</td>
                                    ...
                                    <td class="text-right py-0 align-middle">
                                        <div class="btn-group btn-group-sm">
                                            <a href="/umkm_registration/{{$t->id}}/detail" class="btn btn-warning plus float-right">See Detail</a>
                                        </div>
                                    </td>
                                <tr>
                            </tbody>
